...
LLAppViewerWin32* viewer_app_ptr;
...
int APIENTRY WINMAIN(HINSTANCE hInstance,
                     ...
                     int       nCmdShow)
#else
extern "C" __declspec(dllexport) int startApp()
#endif
{
	...
	viewer_app_ptr = new LLAppViewerWin32("SL-XVR"/*lpCmdLine*/);
...
#else
	viewer_app_ptr->prepareLoop();
	return 0;
}

extern "C" __declspec(dllexport) void runLoop()
{
	if(!LLApp::isQuitting()) 
	{
...
extern "C" __declspec(dllexport) int quitApp()
{
	LLApp::setQuitting();
	viewer_app_ptr->endLoop();
#endif
